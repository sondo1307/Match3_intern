...
public class Cell : MonoBehaviour
{
    ...
    {
        BottomController.Instance.InstatiateCloneAt(this, transform.position, spr);
    ...
    public void Assign(Item item)
    {
        Item = item;
        Item.SetCell(this);
        _spriteRenderer = Item.View.transform.GetComponent<SpriteRenderer>();
        spr = _spriteRenderer.sprite;
