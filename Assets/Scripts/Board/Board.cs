...
public class Board
{
    ...
    public Dictionary<NormalItem.eNormalType, List<Cell>> dictAutoPlay = new Dictionary<NormalItem.eNormalType, List<Cell>>();
    ...
    internal void Fill()
    {
        ...
        for (int i = 0; i< 1; i++)
        {
            dictAutoPlay.Add(NormalItem.eNormalType.TYPE_ONE, new List<Cell>());
            dictAutoPlay.Add(NormalItem.eNormalType.TYPE_TWO, new List<Cell>());
            dictAutoPlay.Add(NormalItem.eNormalType.TYPE_THREE, new List<Cell>());
            dictAutoPlay.Add(NormalItem.eNormalType.TYPE_FOUR, new List<Cell>());
            dictAutoPlay.Add(NormalItem.eNormalType.TYPE_FIVE, new List<Cell>());
            dictAutoPlay.Add(NormalItem.eNormalType.TYPE_SIX, new List<Cell>());
            dictAutoPlay.Add(NormalItem.eNormalType.TYPE_SEVEN, new List<Cell>());
        }

        for (int i = 0; i < 3; i++)
        {
            list.Add(NormalItem.eNormalType.TYPE_ONE);
            list.Add(NormalItem.eNormalType.TYPE_TWO);
            list.Add(NormalItem.eNormalType.TYPE_THREE);
            list.Add(NormalItem.eNormalType.TYPE_FOUR);
            list.Add(NormalItem.eNormalType.TYPE_FIVE);
            list.Add(NormalItem.eNormalType.TYPE_SIX);
            list.Add(NormalItem.eNormalType.TYPE_SEVEN);
        }
        ...
        for (int x = 0; x < boardSizeX; x++)
        {
            for (int y = 0; y < boardSizeY; y++)
            {
                ...
                item.SetType(list[rand]);
                dictAutoPlay[list[rand]].Add(cell);
